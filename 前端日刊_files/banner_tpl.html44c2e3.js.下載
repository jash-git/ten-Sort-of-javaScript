...
});define("biz_wap/jsapi/log.js",["biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js"],function(o){
"use strict";
function i(o,i){
i=e+" "+i+" location:["+location.href+"]",n.isWechat&&n.isMac||r.invoke("log",{
level:o,
msg:i
}),r.invoke("writeLog",{
level:o,
...
var r=o("biz_wap/jsapi/core.js"),n=o("biz_wap/utils/mmversion.js"),e="__wap__",a={
info:function(){
i("info",Array.prototype.join.apply(arguments));
},
warn:function(){
i("warn",Array.prototype.join.apply(arguments));
},
error:function(){
i("error",Array.prototype.join.apply(arguments));
},
debug:function(){
i("debug",Array.prototype.join.apply(arguments));
}
};
